...
public class MainViewController implements Initializable {
    ...
    public void closeButtonMouseEntered(){
        String imagePath = "./imat/resources/icon_close_hover.png";
        closeButtonImageView.setImage(new Image(getClass().getClassLoader().getResourceAsStream(imagePath)));
    }

    @FXML
    public void closeButtonMousePressed(){
        String imagePath = "./imat/resources/icon_close_pressed.png";
        closeButtonImageView.setImage(new Image(getClass().getClassLoader().getResourceAsStream(imagePath)));
    }

    @FXML
    public void closeButtonMouseExited(){
        String imagePath = "./imat/resources/icon_close.png";
        closeButtonImageView.setImage(new Image(getClass().getClassLoader().getResourceAsStream(imagePath)));
    }
}
